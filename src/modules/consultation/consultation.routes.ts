...
import { createConsultation, getConsultation, getAllConsultations, patchConsultation,
         transcribeConsultation, summarizeConsultationController, editSummaryController,
         signConsultationController, getPendingConsultationsController } from "./consultation.controller";
...
router.get('/consultations/pending', authMiddle, getPendingConsultationsController);

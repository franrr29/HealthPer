...
export async function saveChunksAndEmbeddings(
  patient_id: number,
...
export async function getChunksByPatient(
  ...
  // Convierte el embedding almacenado como JSON a un array de números.
...
// Busca los chunks más relevantes utilizando Full-Text Search.

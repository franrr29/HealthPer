...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-100 p-4 pt-16 lg:pt-4 bg-gradient-to-b from-slate-100 via-slate-200 to-slate-300">
      ...
      {/* Mobile-only back bar, fixed so it stays reachable while scrolling */}
      <Link
        to="/"
      ...
      <div className="neu-card flex w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-border bg-white lg:flex-row">
        {/* left panel */}
        <div className="relative flex flex-col items-center justify-center bg-slate-900 px-6 py-12 text-center lg:w-1/2 lg:px-12">

          <img
            src="/banner.png"
            alt="Medical consultation"
            className="w-full max-w-xs rounded-2xl object-cover shadow-md border-4 border-slate-800"
          />
          ...
          <div className="mt-8 max-w-sm">
            <h2 className="text-2xl font-bold leading-tight text-white">
              ...
              <br />
              <span className="text-green-400">better medical records</span>
            </h2>
            <p className="mt-3 text-sm text-slate-400">
              Tools designed to simplify your workflow and improve clinical care for patients.
            </p>
          </div>
        </div>

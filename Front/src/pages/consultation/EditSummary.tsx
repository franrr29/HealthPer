        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3.5 pt-1">
                <button
                    ...
                    className="neu-card bg-slate-900 hover:brightness-110 text-white rounded-xl px-4 py-2 border border-slate-800 text-[11px] font-bold uppercase tracking-wider transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                    {saving ? "Saving..." : "Save"}
                </button>

                {saved && (
                    <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-emerald-700 flex items-center gap-1.5 animate-fade-in">

        ...
        <div className="space-y-4">
            ...
            <div className="max-h-80 overflow-y-auto rounded-lg bg-muted p-4 space-y-3 border border-border">
                <div className="flex items-center gap-1.5 sticky top-0 bg-muted/95 backdrop-blur-sm pb-2 -mx-1 px-1">
                    <Sparkles className="h-3.5 w-3.5 text-navy-elevated" />
                ...
                {questions.map((q, index) => (
                    ...
                    >
                        <div className="flex items-start gap-2.5">
                            <MessageCircleQuestion className="h-4 w-4 text-navy-elevated mt-0.5 shrink-0" />
                            <p className="font-display text-sm font-bold text-foreground leading-snug">
                                {q.question}
                            </p>
                        </div>
                        <p className="text-xs font-medium text-muted-foreground leading-relaxed mt-2 pl-[26px]">
                            {q.reason}
                        </p>
                    </div>
                ))}
